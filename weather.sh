...
echo "Aujourd'hui, la température est de $temp degrés avec une humidité de $humidity. Le vent viendra du $wind_dir avec une vitesse de $wind_speed_kmh km/h." > weather.txt
